...
@testset "Clarabel QP Solver" begin
    @testset "HS071 (Clarabel)" begin
    ...
    @testset "HS037 post office (Clarabel)" begin
        f(x) = -x[1] * x[2] * x[3]
    ...
    @testset "Rosenbrock unconstrained (Clarabel)" begin
